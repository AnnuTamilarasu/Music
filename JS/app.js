const APIController = (function() {
    ...
    const _getPlaylistByGenre = async (token, genreId, limit = 10) => {
...
const UIController = (function() {
    ...
    return {
        ...
        storeToken(value) {
            document.querySelector(DOMElements.hiddentToken).value = value;
        },
        getStoredToken() {
            return {
                token: document.querySelector(DOMElements.hiddentToken).value
            }
        }
    }
})();
